...
SECRET_KEY = 'django-insecure-cqh^-4%&1z*ctl!bc7@b!4hyms+m5hsv)ge-*kavy*@i-1k2t4'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap4',
    'pedidos', #Agregamos la app al proyecto
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'carro.context_processor.importe_total_carro', #Agregamos el contexto del importe total del carro
            ],
        },
    },
]
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'angela6309gonzalez@gmail.com'
EMAIL_HOST_PASSWORD = 'nvae tjfl took damh'



#cargar crispy en bootstrap
